...
const App = {
  ...
  methods: {
    ...
    updateNextLabel() {
      if (this.activeIndex >= this.steps.length - 1) {
        this.statics.labelButtonNext = "Закончить";
      } else {
        this.statics.labelButtonNext = "Вперед";
      }
    },
    nextOfFinish() {
  ...
  computed: {
    ...
    getActiveIndex() {
      return (this.activeIndex < this.steps.length) ? this.activeIndex : (this.steps.length - 1);
    },
